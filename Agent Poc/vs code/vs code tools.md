...
[
  ...
  },
  {
    ...
    "description": "Query the local session store containing history from past coding sessions. Uses SQLite syntax (NOT DuckDB or Postgres). SQL queries are read-only — only SELECT and WITH are allowed. Use `datetime('now', '-1 day')` for date math (NOT `now() - INTERVAL '1 day'`), FTS5 `MATCH` for text search.\n\nTables: `sessions`, `turns`, `session_files`, `session_refs`, `checkpoints`, `search_index`. For column details and query patterns, use the **chronicle** skill.\n\nActions: 'query' (execute SQL — supports JOINs, FTS5 MATCH, aggregations), 'standup' (pre-fetch last 24h data), 'reindex' (rebuild index from debug logs).",
    "parameters": {
      "type": "object",
      "properties": {
        "action": {
        ...
        "questions": {
          ...
          "items": {
            ...
            "properties": {
              "header": {
                "type": "string",
                "description": "Short identifier for the question. Must be unique so answers can be mapped back to the question. Maximum 50 characters.",
                "maxLength": 50
              },
              "question": {
                "type": "string",
                "description": "The question text to display to the user. Keep it concise, ideally one sentence. Maximum 200 characters.",
                "maxLength": 200
              },
              "multiSelect": {
                "type": "boolean",
  ...
  },
  {
    ...
    "description": "Call this tool when you need access to a new category of tools. The category of tools is described as follows:\n\nThis group of tools is designed to facilitate the management and retrieval of details related to Python environments. The tools included are specifically tailored for Python environment management systems such as conda, venv, and others. They provide essential functionalities that allow users to gather information about the Python environment, including the type of environment, the version of Python being used, and a comprehensive list of installed packages along with their respective versions. This information is crucial for developers who need to ensure that their code runs in the correct environment with the necessary dependencies.\n\nThe first tool, 'get_python_environment_details', retrieves detailed information about the Python environment associated with a specified file or workspace. This includes identifying the environment type (like conda or venv), the Python version, and all installed packages. This tool is particularly useful for auditing environments and ensuring that all required packages are present before executing Python scripts.\n\nThe second tool, 'get_python_executable_details', focuses on providing the necessary details to construct the command for executing Python in the terminal. It helps users avoid common pitfalls by generating the fully qualified path to the Python executable, along with any required arguments. This ensures that users can run Python commands accurately, especially in environments where multiple versions of Python may exist.\n\nBoth tools require the invocation of 'configure_python_environment' before use, ensuring that they operate within the correct context. This requirement emphasizes the importance of setting up the environment properly before attempting to retrieve details or execute commands.\n\nTogether, these tools streamline the process of managing Python environments, making it easier for developers to work with different setups and ensuring that their applications run smoothly across various configurations.\n\nBe sure to call this tool if you need a capability related to the above."
  },
  {
    "type": "function",
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_git_add_or_commit",
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_git_blame",
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_git_branch",
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_git_checkout",
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_git_commit_composer",
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_git_fetch",
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_git_graph",
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_git_log_or_diff",
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_git_pull",
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_git_push",
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_git_resolve",
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_git_stash",
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_git_status",
    "description": " Show the working tree status (git status), will open a UI if client supports it.",
    "parameters": {
      "type": "object",
      "properties": {
        "directory": {
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_git_worktree",
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_gitkraken_workspace_list",
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_gitlens_commit_composer",
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_gitlens_launchpad",
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_gitlens_start_review",
    "description": " Gitlens Start Review. Creates a dedicated worktree and reviews your PR with an AI agent.",
    "parameters": {
      "type": "object",
      "properties": {
        "directory": {
        ...
        "instructions": {
          "description": "OPTIONAL. Use this ONLY if the user explicitly provided specific requirements about the review focus, review criteria, or what aspects to check. Do NOT use this parameter unless you are 100% certain about the user's intentions. Examples: 'focus on security issues', 'check for performance regressions', 'review only the authentication logic'.",
          "type": "string"
        },
        "pr_url": {
          "description": "URL of the PR to start review.",
          "type": "string"
        }
      },
      "required": [
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_gitlens_start_work",
    "description": " Gitlens Start Work. Creates a work based on an issue. This tool will create a branch and link it with the issue, keeping context visible throughout your work.",
    "parameters": {
      "type": "object",
      "properties": {
        "directory": {
        ...
        "instructions": {
          "description": "OPTIONAL. Use this ONLY if the user explicitly provided specific requirements about the implementation approach, or additional context to supplement the issue. Do NOT use this parameter unless you are 100% certain about the user's intentions.",
          "type": "string"
        },
        "issue_url": {
          "description": "URL of the issue to start work on.",
          "type": "string"
        }
      },
      "required": [
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_issues_add_comment",
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_issues_assigned_to_me",
    ...
    "parameters": {
      ...
      "properties": {
        ...
        "project": {
          "description": "Project key. Jira only (e.g. GKDEV).",
          "type": "string"
        },
        "provider": {
          "description": "Specify the issue provider",
        ...
        "repository_name": {
          "description": "Repository name. GitHub only; must be combined with repository_organization.",
          "type": "string"
        },
        "repository_organization": {
          "description": "Organization name. GitHub only.",
          "type": "string"
        }
      },
      "required": [
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_issues_create",
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_issues_get_detail",
    "description": "Retrieve detailed information about a specific issue by its unique ID. For Jira Epics, the response includes a childIssues array containing all issues linked to the epic.",
    "parameters": {
      "type": "object",
      "properties": {
        "azure_organization": {
        ...
        "issue_id": {
          "description": "The Number or ID of the issue to retrieve. Supported formats include GitHub/GitLab numeric IDs (e.g., 123 or #123), Jira keys (e.g., PROJ-123), Linear issue IDs (UUID format), etc.",
          "type": "string"
        },
        "provider": {
          "description": "Specify the issue provider",
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_pull_request_assigned_to_me",
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_pull_request_create",
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_pull_request_create_review",
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_pull_request_get_comments",
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_pull_request_get_detail",
  ...
  {
    "type": "function",
    "name": "mcp_gitkraken_cli_repository_get_file_content",
